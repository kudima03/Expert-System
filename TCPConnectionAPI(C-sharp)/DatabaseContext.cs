...
namespace TCPConnectionAPI_C_sharp_
{
    class DatabaseContext : IMainDBPermission
    {
        ...
        virtual public List<Vehicle> FindVehiclesWhere(Func<Vehicle, bool> comparer)
        {
            return DBconnection.VehicleSet
                .Include("Rate.Expert")
                .Where(comparer)
                .ToList();
        }
        ...
        virtual public bool UpdateVehicle(Vehicle newVersion)
        {
            ...
            else
            {
                ...
                buf.RegistrationNumber = newVersion.RegistrationNumber;
                buf.TotalRate = newVersion.TotalRate;
                buf.Model = newVersion.Model;
